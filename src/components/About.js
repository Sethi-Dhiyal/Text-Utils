  ...
  return (
    <div className="container" style={mystate}>
      ...
      <div className="accordion" id="accordionExample" style={mystate}>
        ...
        <div className="accordion-item">
          ...
          <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
            <div className="accordion-body" style={mystate}>
              <strong>This is the third item's accordion body.</strong> You can modify this content to fit your needs.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container my-3">
        <button onClick={toggleStyle} className="btn btn-primary my-3" style={mystate}>
          {btnText}
        </button>
      </div>
    </div>
